...
class TestProgram(unittest.TestCase):
    ...
    def test_case_1(self):
        ...
        iterativeInOrderTraversal(test1, actualTestCallback)
        self.assertEqual(testArray, [1])

    def test_case_2(self):
        testArray = []
        actualTestCallback = lambda x: testCallback(testArray, x)
        iterativeInOrderTraversal(test2, actualTestCallback)
        self.assertEqual(testArray, [4, 2, 1, 3])

    def test_case_3(self):
        testArray = []
        actualTestCallback = lambda x: testCallback(testArray, x)
        iterativeInOrderTraversal(test3, actualTestCallback)
        self.assertEqual(testArray, [4, 2, 5, 1, 6, 3, 7])

    def test_case_4(self):
        testArray = []
        actualTestCallback = lambda x: testCallback(testArray, x)
        iterativeInOrderTraversal(test4, actualTestCallback)
        self.assertEqual(testArray, [8, 4, 9, 2, 10, 5, 1, 6, 3, 7])

    def test_case_5(self):
        testArray = []
        actualTestCallback = lambda x: testCallback(testArray, x)
        iterativeInOrderTraversal(test5, actualTestCallback)
        self.assertEqual(testArray, [8, 4, 9, 2, 10, 5, 11, 1, 12, 6, 13, 3, 7])

    def test_case_6(self):
        testArray = []
        actualTestCallback = lambda x: testCallback(testArray, x)
        iterativeInOrderTraversal(test6, actualTestCallback)
